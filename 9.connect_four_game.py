""" This is my implementation of the popular Connect Four game. More features, like different numbers, borders, etc. can be added but the essential part of displaying the board
and placing the 'X' and 'O' works well.

The implementation has 3 parts: I - creating and displaying the board, II - making some functions that allow the user to interact with the board, III - determining who won the game
and setting up a loop for a game to continue until the end
"""
